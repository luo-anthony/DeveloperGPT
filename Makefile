...
# 	@rm -rf .venv
# 	@poetry init --no-interaction --name=developergpt --author=luo-anthony
# 	@echo "" >> pyproject.toml
# 	@echo "[tool.poetry.scripts]" >> pyproject.toml
# 	@echo "developergpt = 'developergpt.__main__:main'" >> pyproject.toml
